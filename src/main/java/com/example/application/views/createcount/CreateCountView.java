 ...
 */
@PageTitle("Create Count")
@Route(value = "create-count", layout = MainLayout.class)
@AnonymousAllowed
@Tag("create-count-view")
@JsModule("./views/createcount/create-count-view.ts")
@Uses(Icon.class)
public class CreateCountView extends LitTemplate {
    ...
    public CreateCountView(SamplePersonService personService) {
    ...
    private static class PhoneNumberField extends CustomField<String> {
        ...
        public void setForm(CreateCountView form) {
            this.form = form;
        }
